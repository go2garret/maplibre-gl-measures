...
export default class MeasuresControl {
  ...
  _initControl() {
    ...
    this._container.className = "maplibregl-ctrl mapboxgl-ctrl maplibre-gl-measures maplibregl-ctrl-group mapboxgl-ctrl-group";
    // Add header
      ...
      try {        
        if (feature.geometry.type == "Polygon") {
          ...
          segments.features.forEach((segment) => {
            ...
            try {
              lengthConverted = parseFloat(lengthConverted).toFixed(2);
            } catch(e) {
              //
            }            
            centroid.properties = {
